...
-- ----------------------------
BEGIN;
INSERT INTO `sys_dept` VALUES (1, '山东', 1, '2018-01-22 19:00:23', '2021-08-31 15:04:07', 1, 0);
INSERT INTO `sys_dept` VALUES (2, '沙县国际', 2, '2018-01-22 19:00:38', '2021-08-31 15:04:07', 1, 0);
INSERT INTO `sys_dept` VALUES (3, '潍坊', 3, '2018-01-22 19:00:44', '2021-08-31 15:04:07', 1, 1);
INSERT INTO `sys_dept` VALUES (4, '高新', 4, '2018-01-22 19:00:52', '2021-08-31 15:04:07', 1, 3);
INSERT INTO `sys_dept` VALUES (5, '院校', 5, '2018-01-22 19:00:57', '2021-08-31 15:04:07', 1, 4);
INSERT INTO `sys_dept` VALUES (6, '潍院', 6, '2018-01-22 19:01:06', '2019-05-18 14:56:16', 1, 5);
INSERT INTO `sys_dept` VALUES (7, '山东沙县', 7, '2018-01-22 19:01:57', '2021-08-31 15:04:07', 1, 2);
INSERT INTO `sys_dept` VALUES (8, '潍坊沙县', 8, '2018-01-22 19:02:03', '2021-08-31 15:04:07', 1, 7);
COMMIT;
...
CREATE TABLE `sys_dict` (
  `dict_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  ...
  KEY `sys_dict_del_flag` (`enabled`) USING BTREE
...
CREATE TABLE `sys_dict_item` (
  ...
  KEY `sys_dict_del_flag` (`enabled`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8mb4 COMMENT='字典项';
...
CREATE TABLE `sys_file` (
  ...
  `original_name` varchar(100) DEFAULT NULL COMMENT '文件原名',
  ...
  `create_user` bigint(20) DEFAULT NULL COMMENT '上传者id',
...
CREATE TABLE `sys_menu` (
  ...
  `keep_alive` int(1) DEFAULT '0',
  `type` int(1) DEFAULT '0',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `enabled` int(1) DEFAULT '1',
  PRIMARY KEY (`menu_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9007 DEFAULT CHARSET=utf8mb4 COMMENT='菜单权限表';
...
CREATE TABLE `sys_user` (
  `user_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '主键ID',
  `user_name` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用户名',
  `nick_name` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '昵称',
  ...
  `enabled` varchar(2) COLLATE utf8mb4_general_ci DEFAULT '1' COMMENT '1-可用；0-禁用',
  `user_sex` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '1-男；0-女',
  `login_time` datetime DEFAULT NULL,
PRIMARY KEY (`user_id`),
KEY `user_idx1_username` (`nick_name`)
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 'admin', '管理员', '$2a$10$H3p/ptZ9U8LoR1kwF5CF/eGn92yFTPO6ma0jgeOhVJMsw/oFyez.6', '13800138000', '', 1, '2018-04-20 07:15:18', '2021-09-04 17:44:34', 0, 0, 1);
INSERT INTO `sys_user` VALUES ('101', '1001', '坐席1号', '$2a$10$7Zw8ZCQiRsnLs7xIumMEaOJvCoLirFjUMz089vQbHjdV0nzZ38fuq', '13138001380', NULL, 2, '2021-09-16 14:34:19', '2021-10-21 14:26:12', 0, 0, 1);
INSERT INTO `sys_user` VALUES ('102', '1002', '坐席2号', '$2a$10$7Zw8ZCQiRsnLs7xIumMEaOJvCoLirFjUMz089vQbHjdV0nzZ38fuq', '13138001380', NULL, 2, '2021-09-16 14:34:42', '2021-10-21 14:26:17', 0, 0, 1);
INSERT INTO `sys_user` VALUES ('103', '1003', '坐席3号', '$2a$10$7Zw8ZCQiRsnLs7xIumMEaOJvCoLirFjUMz089vQbHjdV0nzZ38fuq', '13138001380', NULL, 2, '2021-10-16 14:21:45', '2021-10-21 14:26:23', 0, 0, 1);
INSERT INTO `sys_user` VALUES ('104', '1004', '坐席4号', '$2a$10$7Zw8ZCQiRsnLs7xIumMEaOJvCoLirFjUMz089vQbHjdV0nzZ38fuq', '13138001380', NULL, 2, '2021-10-16 14:36:43', '2021-10-26 16:04:15', 0, 0, 1);
INSERT INTO `sys_user` VALUES ('105', '1005', '坐席5号', '$2a$10$7Zw8ZCQiRsnLs7xIumMEaOJvCoLirFjUMz089vQbHjdV0nzZ38fuq', '13138001380', NULL, 2, '2021-10-21 17:55:17', '2021-10-21 17:55:43', 0, 0, 1);
COMMIT;
