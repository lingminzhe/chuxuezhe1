...
public class SysUserInfoVo implements Serializable {
    ...
    @ApiModelProperty(value = "管理机构id集合")
    private List<Long> manageOrgIdList;

    @ApiModelProperty(value = "管理机构编码集合")
    private List<String> manageOrgCodeList;

    @ApiModelProperty(value = "管理区域id集合")
    private List<Long> areaIdList;

    @ApiModelProperty(value = "管理区域编码集合")
