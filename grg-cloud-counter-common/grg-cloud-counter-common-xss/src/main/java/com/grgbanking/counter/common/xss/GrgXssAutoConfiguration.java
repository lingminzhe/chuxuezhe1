...
package com.grgbanking.counter.common.xss;

import com.grgbanking.counter.common.xss.config.XssProperties;
import com.grgbanking.counter.common.xss.core.*;
...
public class GrgXssAutoConfiguration implements WebMvcConfigurer {
