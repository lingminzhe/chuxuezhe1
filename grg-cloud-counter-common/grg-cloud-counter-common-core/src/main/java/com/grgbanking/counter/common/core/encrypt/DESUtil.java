			...
			if (leng < 4) {
				...
				if (firstKey != null && firstKey != "" && secondKey != null && secondKey != "" && thirdKey != null && thirdKey != "") {
					...
					for (x = 0; x < firstLength; x++) {
						if (firstKeyBt != null && firstKeyBt.get(x) != null) {
							tempBt = enc(tempBt, (int[]) firstKeyBt.get(x));
						}
					}
					for (y = 0; y < secondLength; y++) {
						if (secondKeyBt != null && secondKeyBt.get(y) != null) {
							tempBt = enc(tempBt, (int[]) secondKeyBt.get(y));
						}
					}
					for (z = 0; z < thirdLength; z++) {
						if (thirdKeyBt != null && thirdKeyBt.get(z) != null) {
		...
		for (i = 0; i < iterator; i++) {
			...
			if (firstKey != null && !"".equals(firstKey) && secondKey != null && !"".equals(secondKey) && thirdKey != null && !"".equals(thirdKey)) {
				...
				for (x = thirdLength - 1; x >= 0; x--) {
					if (thirdKeyBt != null && thirdKeyBt.get(x) != null) {
				...
				for (z = firstLength - 1; z >= 0; z--) {
					if (firstKeyBt != null && firstKeyBt.get(z) != null) {
				...
				if (firstKey != null && !"".equals(firstKey) && secondKey != null && !"".equals(secondKey)) {
					...
					for (x = secondLength - 1; x >= 0; x--) {
						if (secondKeyBt != null && secondKeyBt.get(x) != null) {
							tempBt = dec(tempBt, (int[]) secondKeyBt.get(x));
						}
					}
					for (y = firstLength - 1; y >= 0; y--) {
						if (firstKeyBt != null && firstKeyBt.get(y) != null) {
