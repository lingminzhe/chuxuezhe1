package com.grgbanking.counter.common.swagger.config;
...
//		pars.add(versionPar.build());
		...
		ApiSelectorBuilder builder = new Docket(DocumentationType.OAS_30).enable(swaggerProperties.getEnabled()).host(swaggerProperties.getHost())
				.apiInfo(apiInfo(swaggerProperties)).globalRequestParameters(null).select()
